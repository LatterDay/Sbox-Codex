...
- **`handlerCount` lower than 145** in `get_bridge_status` → the addon didn't fully compile, or some handlers failed to register. Check `get_compile_errors` / the log for `Failed to register`.
