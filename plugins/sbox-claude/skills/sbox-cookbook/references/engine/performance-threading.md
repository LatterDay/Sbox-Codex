...
protected override int BuildHash()
    => HashCode.Combine(
        ...
        Spawner?.Revision    ?? 0,
        (int)(SpawnProgress * 100)  // quantize to 100 buckets — re-renders ~once per 1%
    );
```
